...
- **Services** (`/services`) — hero, services-detailed, cta
- **About** (`/about`) — hero, content, team, certifications
...
git clone https://github.com/CyberParv/proj_mlvlhkxd.git
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/CyberParv/proj_mlvlhkxd)
